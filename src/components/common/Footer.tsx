...
const Footer = () => {
  return (
    <footer className="bg-blue-800 pt-16 pb-8"> 
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            />
            <p className="text-white/90 mb-6 max-w-md sm:max-w-sm">
            ...
            <div className="flex space-x-4 mb-8 sm:mb-0">
              <a 
                href="https://www.facebook.com/share/16VFXCu1Ku/?mibextid=wwXIfr" 
                target="_blank"
              ...
              <a 
                href="https://www.instagram.com/paani_digitalmarketingagency?igsh=MWplb3FzczZoNHhkcg==" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/90 hover:text-white transition-colors duration-300"
              >
              ...
              <a 
                href="https://www.tiktok.com/@paanidigitalmarketing?_t=ZS-8wOe0lryiW7&_r=1" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/90 hover:text-white transition-colors duration-300"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64c.28 0 .54.04.79.13V9.4a6.33 6.33 0 00-1-.08A6.34 6.34 0 003 15.66a6.34 6.34 0 0010.95-4.32V8.17a8.16 8.16 0 004.65 1.46V6.18z"/>
                </svg>
              </a>
            </div>
          </motion.div>
